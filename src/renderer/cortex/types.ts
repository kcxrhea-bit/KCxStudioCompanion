...
export type CortexEventType = "runtime-state-changed" | "bridge-state-changed" | "provider-registered" | "permission-updated" | "ecosystem-alert" | "cortex-status-changed" | "project-context-updated" | "cortex-execution-completed" | "build-log-line" | "system-state-changed" | "system-logs-cleared" | "build-failure-detected" | "spec-intake-completed" | "spec-intake-status";
